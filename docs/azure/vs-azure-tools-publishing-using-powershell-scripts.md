...
若要获取可在 Windows PowerShell 命令提示符处使用的函数的相关帮助，请使用 `Get-Help function-name` 命令。 帮助中包含参数帮助和示例。 同一帮助文本也位于脚本源文件 **AzureWebAppPublishModule.psm1** 和 **Publish-WebApplication.ps1。** 脚本和帮助已使用 Visual Studio 语言本地化。
