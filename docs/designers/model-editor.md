...
|工具栏项|说明|
|------------------|-----------------|
|**Select**|基于活动的选择模式，选择场景中的点、边、面或对象。|
...
|**视图**|设置视图方向。 以下是可用方向：<br /><br /> **Front**<br /> 将视图定位在场景的正面。<br /><br /> **后退**<br /> 将视图定位在场景的背面。<br /><br /> **Left**<br /> 将视图定位在场景的左侧。<br /><br /> **Right**<br /> 将视图定位在场景的右侧。<br /><br /> 顶部<br /> 将视图定位在场景的顶面。<br /><br /> **下**<br /> 将视图定位在场景的底面。 注意：启用“正交”投影时，这是更改视图方向的唯一方式。|
