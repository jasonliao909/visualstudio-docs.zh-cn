...
有关如何使用创建 Windows Installer 文件的信息 [!INCLUDE[vs_dev10_long](../sharepoint/includes/vs-dev10-long-md.md)] ，请参阅 [使用 Windows Installer 部署 Visual Studio 2010 Tools for Office 解决方案](/previous-versions/visualstudio/visual-studio-2010/ff937654(v=msdn.10))。
