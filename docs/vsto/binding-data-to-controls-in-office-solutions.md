---
title: 将数据绑定到解决方案中的Office控件
description: 了解如何将 Word 文档Windows窗体控件和宿主控件Microsoft Office或Excel绑定到数据源。
...
ms.locfileid: "122059876"
---
# <a name="bind-data-to-controls-in-office-solutions"></a>将数据绑定到解决方案中的Office控件
 ...
 宿主控件扩展 Word 和 Excel 对象模型中的对象，例如 Word 中的内容控件和 Excel 中的命名范围。 有关详细信息，请参阅主机 [项和主机控件概述](../vsto/host-items-and-host-controls-overview.md)。

 Windows 窗体和宿主控件使用Windows 窗体数据绑定模型，该模型支持到数据源（例如数据集和数据表）的 *简单数据绑定* 和 *复杂数据绑定* 。 有关表单中数据绑定模型的完整Windows，请参阅数据[绑定和Windows窗体](/dotnet/framework/winforms/data-binding-and-windows-forms)。
...
## <a name="simple-data-binding"></a>简单数据绑定
 ...
 有关演示简单数据绑定的演练，请参阅演练：文档级项目[](../vsto/walkthrough-simple-data-binding-in-a-document-level-project.md)的文档级项目中的简单数据绑定和演练：VSTO 外接程序项目的[VSTO](../vsto/walkthrough-simple-data-binding-in-vsto-add-in-project.md)外接程序项目中的简单数据绑定。
...
## <a name="complex-data-binding"></a>复杂数据绑定
 ...
 若要执行复杂数据绑定，请将控件的 `DataSource` 属性设置为复杂数据绑定支持的数据源对象。 例如， <xref:Microsoft.Office.Tools.Excel.ListObject.DataSource%2A> 控件的 <xref:Microsoft.Office.Tools.Excel.ListObject> 属性可以绑定到一个数据表中的多个列。 数据表中的所有数据都在 <xref:Microsoft.Office.Tools.Excel.ListObject> 控件中显示，而当数据表中的数据发生更改时， <xref:Microsoft.Office.Tools.Excel.ListObject> 也会发生更改。 有关可用于复杂数据绑定的数据源的列表，请参阅 Windows[支持的数据源](/dotnet/framework/winforms/data-sources-supported-by-windows-forms)。
 ...
 有关演示复杂数据绑定的演练，请参阅演练：文档级[](../vsto/walkthrough-complex-data-binding-in-a-document-level-project.md)项目的文档级项目中的复杂数据绑定和演练[：VSTO](../vsto/walkthrough-complex-data-binding-in-vsto-add-in-project.md)外接程序项目的 VSTO 外接程序项目中的复杂数据绑定。

## <a name="display-data-in-documents-and-workbooks"></a>在文档和工作簿中显示数据
 在文档级项目中，可通过与用于 Windows 窗体相同的方法，使用“数据源”  窗口轻松地将数据绑定控件添加到文档或工作簿中。 有关使用"数据源"窗口[Windows，请参阅将](../data-tools/bind-windows-forms-controls-to-data-in-visual-studio.md)窗体控件绑定到Visual Studio和添加新[数据源](../data-tools/add-new-data-sources.md)。
...
### <a name="bind-data-in-document-level-projects-at-design-time"></a>在设计时绑定文档级项目中的数据
 下面的主题介绍在设计时绑定数据的示例：
...
### <a name="bind-data-in-vsto-add-in-projects"></a>在外接程序VSTO中绑定数据
 在 VSTO 外接程序项目中，仅可在运行时添加控件。 下面的主题介绍在运行时绑定数据的示例：

- [演练：在外接程序项目中VSTO数据绑定](../vsto/walkthrough-simple-data-binding-in-vsto-add-in-project.md)

- [演练：外接程序项目中VSTO数据绑定](../vsto/walkthrough-complex-data-binding-in-vsto-add-in-project.md)
...
## <a name="update-data-that-is-bound-to-host-controls"></a>更新绑定到宿主控件的数据
 ...
 有关详细信息，请参阅 [如何：使用主机控件 中的数据更新数据源](../vsto/how-to-update-a-data-source-with-data-from-a-host-control.md)。

## <a name="see-also"></a>请参阅
- [数据绑定和Windows窗体](/dotnet/framework/winforms/data-binding-and-windows-forms)
- [如何：在窗体上创建简单绑定Windows控件](/dotnet/framework/winforms/how-to-create-a-simple-bound-control-on-a-windows-form)
