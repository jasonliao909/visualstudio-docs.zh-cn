...
ms.locfileid: "122032155"
---
# <a name="troubleshoot-office-solution-security"></a>解决 Office 解决方案安全性问题
...
## <a name="solutions-cannot-be-installed-from-network-file-shares-or-web-locations-when-internet-explorer-enhanced-security-configuration-or-internet-explorer-7-is-installed"></a>如果安装了 Internet Explorer 增强的安全配置或 Internet Explorer 7，则无法从网络文件共享或 web 位置安装解决方案
 ...
 若要管理 IEESC 和 Internet Explorer 7 及更高版本的效果，请确定网站和通用命名约定 (你信任的 UNC) 路径，并将这些路径添加到 (本地 intranet 或受信任站点) 的某个受信任的安全区域。有关如何管理区域的信息，请参阅[Configure ClickOnce 受信任的发布者](/previous-versions/dotnet/articles/ms996418(v=msdn.10))。
