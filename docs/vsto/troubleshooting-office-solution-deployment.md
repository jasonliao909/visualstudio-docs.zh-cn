...
## <a name="prompt-to-manually-uninstall-appears-when-you-publish-and-install-a-solution-on-the-development-computer"></a>当你在开发计算机上发布和安装解决方案时显示手动卸载提示
