...
|程序集名称|说明|
|-------------------|-----------------|
|Microsoft.Office.Tools.Common.dll|提供以下类型：<br /><br /> - 用于创建功能区自定义项和智能标记的类型。 **注意：**      智能标记在 和 中 [!INCLUDE[Excel_14_short](includes/excel-14-short-md.md)] 已弃用 [!INCLUDE[Word_14_short](includes/word-14-short-md.md)] 。<br />- 在文档级自定义项和外接程序中的自定义任务VSTO创建操作窗格的类型。|
...
## <a name="assemblies-in-the-office-extensions-for-the-net-framework-35"></a>3.5 Office 3.5 .NET Framework程序集
...
|程序集名称|说明|
|-------------------|-----------------|
|Microsoft.Office.Tools.Common.v9.0.dll|提供以下类型：<br /><br /> - Microsoft。Office。用于外接程序的 Tools.AddIn VSTO类。<br />- 用于创建功能区自定义项和智能标记的类。 **注意：**      智能标记在 和 中 [!INCLUDE[Excel_14_short](includes/excel-14-short-md.md)] 已弃用 [!INCLUDE[Word_14_short](includes/word-14-short-md.md)] 。<br />- 在文档级自定义项和外接程序中的自定义任务窗格中创建操作窗格VSTO类。|
...
|Microsoft.Office.Tools.v9.0.dll|提供以下类型：<br /><br /> - [RemoteBindableComponent](/previous-versions/visualstudio/visual-studio-2008/bb546360(v=vs.90)) 类，该类为文档级自定义项中的宿主控件提供数据绑定功能。<br />- 属于运行时基础结构Visual Studio Tools for Office，不应直接从代码使用的其他类型。|
...
|Microsoft.VisualStudio.Tools.Applications.Runtime.v10.0.dll|提供 <xref:Microsoft.VisualStudio.Tools.Applications.Deployment.IAddInPostDeploymentAction> 接口，可实现该接口以将其他安装步骤作为 Office 解决方案的 ClickOnce 安装程序的最后一步进行运行。 有关详细信息，请参阅高级[Office部署](/previous-versions/visualstudio/visual-studio-2010/dd234217(v=vs.100))。|
