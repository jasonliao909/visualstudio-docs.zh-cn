...
|程序集名称|说明|
|-------------------|-----------------|
|Microsoft.Office.Tools.Common.v9.0.dll|提供以下类型：<br /><br /> - Microsoft。Office。用于外接程序的 Tools.AddIn VSTO类。<br />- 用于创建功能区自定义项和智能标记的类。 **注意：**      智能标记在 和 中 [!INCLUDE[Excel_14_short](includes/excel-14-short-md.md)] 已弃用 [!INCLUDE[Word_14_short](includes/word-14-short-md.md)] 。<br />- 在文档级自定义项和外接程序中的自定义任务VSTO窗格的类。|
