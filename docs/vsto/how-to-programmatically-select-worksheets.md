...
ms.workload:
- office
ms.openlocfilehash: 64f8e02ae830b1e71f6ee9650166cd0eb900b1e3eaf6545eaafdb45ded4f1fdd
ms.sourcegitcommit: c72b2f603e1eb3a4157f00926df2e263831ea472
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/12/2021
ms.locfileid: "121285538"
---
# <a name="how-to-programmatically-select-worksheets"></a>如何：以编程方式选择工作表
 ...
 如果要在 VSTO 外接程序中选择现有工作表，或者如果工作表是在文档级自定义项中运行时创建的，则必须使用 Excel 工作簿的 Excel 集合访问它;否则，可以直接访问 <xref:Microsoft.Office.Interop.Excel.Sheets> 宿主项。 <xref:Microsoft.Office.Tools.Excel.Worksheet>
