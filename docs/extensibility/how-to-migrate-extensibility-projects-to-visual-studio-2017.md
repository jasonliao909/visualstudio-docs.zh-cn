...
若要在新的 VSIX v3 (版本 3) 格式中生成扩展，你的解决方案将需要通过新的 VSSDK 生成工具生成。 这将与 Visual Studio 2017 一起安装，但 VSIX v2 扩展可能会通过 NuGet 保存对较旧版本的引用。 如果是这样，你将需要为你的解决方案手动安装 VSSDK NuGet 包的更新。
