...
|) 文件系统或本地 IIS Web 项目查看独占 (COE|1. 将 Web 服务器连接设置为 "**工具**"、"**选项**"、"**项目**"、" **web 设置** 中的文件共享。<br />2. 创建 Web 项目。<br />3. 将解决方案添加到源代码管理。<br />4.**仅查看 (** **文件**、**源代码管理**) 的整个项目。|检查发生。|
...
|操作|测试步骤|要验证的预期结果|
|------------|----------------|--------------------------------|
|断开连接时，请查看文件，然后连接进行同步|1. 使用 "更改源代码管理" 对话框断开受控项目的连接 (**文件**、 **源代码管理**、 **更改源代码管理**) 。<br />2. 签出文件。<br />3. 在警告对话框中，单击 "签出 (断开连接) "。<br />4. 编辑该文件。<br />5. 使用 "更改源代码管理" 对话框连接。<br />6. 获取编辑过的文件的最新版本。|常见的预期行为|
...
|将文件 () 添加到项目后，撤消项目的签出|1. 创建一个新项目并将其添加到源代码管理。<br />2. 签出项目。<br />3. 将文件添加到项目。<br />4. 撤消项目的签出。|添加的文件将从解决方案资源管理器中的项目中删除。<br /><br /> Project 不再处于签出状态。|
|从项目中删除文件 () 后撤消签出项目|1. 创建一个新项目并将其添加到源代码管理。<br />2. 签出项目。<br />3. 从项目中删除文件。<br />4. 撤消项目的签出。|删除的文件显示在解决方案资源管理器中的项目下。<br /><br /> Project 不再处于签出状态。|
