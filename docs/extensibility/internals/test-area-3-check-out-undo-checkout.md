...
- 接受撤消后，系统解决方案资源管理器受影响的文件更新图标，并且该项将从"挂起 **的签入**"窗口中删除。
...
|从项目中删除文件后撤消 () 签出|1.创建新项目并将其添加到源代码管理。<br />2.查看项目。<br />3.从项目中删除文件。<br />4.撤消项目的签出。|已删除的文件将显示在项目下解决方案资源管理器。<br /><br /> Project不再签出。|
