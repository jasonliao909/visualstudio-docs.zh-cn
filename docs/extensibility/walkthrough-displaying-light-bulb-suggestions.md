...
ms.locfileid: "126601023"
---
# <a name="walkthrough-display-light-bulb-suggestions"></a>演练：显示灯泡建议
灯泡是编辑器中的图标Visual Studio展开以显示一组操作，例如，对内置代码分析器或代码重构所识别问题的修复。

 在 Visual C# 和 Visual Basic 编辑器中，还可使用 .NET Compiler Platform ("Roslyn") 通过自动显示灯泡的操作编写和打包自己的代码分析器。 有关详细信息，请参阅：
...
- [如何：编写Visual Basic和代码修复](https://github.com/dotnet/roslyn/blob/master/docs/wiki/How-To-Write-a-Visual-Basic-Analyzer-and-Code-Fix.md)
  ...
  灯泡如下所示。 在 Visual Basic 或 Visual C# 项目中，如果变量名称无效，则会出现一个红色长线。 如果将鼠标悬停在无效标识符上，光标附近会出现一个灯泡。
