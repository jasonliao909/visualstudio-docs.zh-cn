...
description: 了解将扩展迁移到 2022 预览版时可能需要的 VS SDK Visual Studio包Visual Studio NuGet 包。
ms.date: 06/08/2021
ms.topic: conceptual
...
ms.locfileid: "112308554"
---
# <a name="sdk-reference-packages"></a>SDK 参考包

[!INCLUDE [preview-note](../includes/preview-note.md)]

创作扩展Visual Studio方法是引用[ `Microsoft.VisualStudio.Sdk` NuGet 包](https://www.nuget.org/packages/microsoft.visualstudio.sdk)。
...
下表提供了从程序集或包进行映射，Visual Studio 2022 年 2 月之前扩展可能已经引用了新的包 ID，在面向 Visual Studio 2022 时引用。 在某些情况下，程序集现在在 NuGet 包中可用，这些包以前只能从本地 Visual Studio安装。
