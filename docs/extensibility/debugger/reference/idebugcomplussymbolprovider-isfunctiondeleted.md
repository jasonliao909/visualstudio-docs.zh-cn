...
`pAddress`\
[in]由 [IDebugAddress 接口表示的调试](../../../extensibility/debugger/reference/idebugaddress.md) 地址。 此地址必须是METHOD_ADDRESS。

## <a name="return-value"></a>返回值
如果删除该函数，则 返回 `S_OK` 。 如果该函数存在，则返回 `S_FALSE` 。
