...
`pAddress`\
中 [IDebugAddress](../../../extensibility/debugger/reference/idebugaddress.md) 接口所表示的调试地址。 此地址必须是 METHOD_ADDRESS。

## <a name="return-value"></a>返回值
如果删除该函数，则返回 `S_OK` 。 如果此函数存在，则返回 `S_FALSE` 。
