...
description: 了解如何在不使用项目或解决方案的情况下直接在 Visual Studio 中开发代码。
...
- 选择 Visual Studio“开始”页上的“打开文件夹”链接 。
    ...
    > [!IMPORTANT]
    > 并非所有代码都可以通过使用 Visual Studio“开始页”中的“打开文件夹”链接来打开。 例如，如果代码文件已另存为解决方案的一部分（换言之，在 .sln 文件中），你必须使用此处列出的其他选项之一来打开代码。
...
- 在“启动”窗口中选择“打开文件夹”链接。
    ...
    > [!IMPORTANT]
    > 并非所有代码都可以通过使用 Visual Studio“开始”窗口中的“打开文件夹”链接来打开。 例如，如果代码文件已另存为解决方案的一部分（换言之，在 .sln 文件中），你必须使用此处列出的其他选项之一来打开代码。
