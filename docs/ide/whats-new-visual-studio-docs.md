---
title: Visual Studio 文档：2021 年 3 月新增功能
titleSuffix: ''
description: 2021 年 3 月 Visual Studio 文档中的新增功能。
ms.date: 04/02/2021
helpviewer_keywords:
...
欢迎了解 2021 年 3 月 Visual Studio 文档中的新增功能。 本文列出了 7 月份对文档进行的一些重大更改。 有关前几月新增功能的信息，请参阅[新增功能历史记录](whats-new-visual-studio-docs-history.md)文章。

## <a name="code-quality"></a>代码质量

**更新的文章**

- [如何：手动为托管代码运行旧式代码分析](../code-quality/how-to-run-legacy-code-analysis-manually-for-managed-code.md) - 确认从工作分支合并
...
- [VisibilityItem 元素](../extensibility/visibilityitem-element.md) - 确认从工作分支合并
...
- [教程：打开存储库中的项目](../get-started/tutorial-open-project-from-repo-visual-studio-2019.md)
  ...
  - 向登录部分添加登录链接，使内容更详实
- [教程：Visual Studio 中的 C# 和 ASP.NET Core 入门](../get-started/csharp/tutorial-aspnet-core.md)
  - 确认从工作分支合并
...
- [对 MSBuild 问题进行故障排除并为其创建日志](./msbuild-logs.md) - 确认从工作分支合并
