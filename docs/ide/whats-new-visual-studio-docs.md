---
title: Visual Studio 文档：2021 年 9 月新增功能
titleSuffix: ''
description: 2021 年 9 月 Visual Studio 文档中的新增功能。
ms.date: 10/01/2021
helpviewer_keywords:
...
欢迎了解 2021 年 9 月 Visual Studio 文档中的新增功能。 本文列出了 7 月份对文档进行的一些重大更改。 有关前几月新增功能的信息，请参阅[新增功能历史记录](#whats-new-history)部分。
...
## <a name="community-contributors-in-september"></a>9 月社区参与者
