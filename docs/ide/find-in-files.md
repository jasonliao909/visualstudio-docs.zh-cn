...
还可使用相邻的"浏览 **(...)** 按钮找到要搜索的位置。 更好的是，如果已指定目录，此按钮将追加新目录，而不是替换它。 例如，如果你的“查找方式”值为“.\Code”，可以单击“浏览(...)”按钮并导航到名为“共享代码”的文件夹。 “浏览(...)”框现在将显示“.\Code;.\Shared Code”，在执行 Find 命令时，它将搜索这两个文件夹。
