---
description: VTable) 符号具有由 SymTagVTableShape 标记标识的类子符号。
...
[VTable](../../debugger/debug-interface-access/vtable.md)符号具有由标记标识的类子符号 `SymTagVTableShape` 。
...
|[IDiaSymbol::get_symTag](../../debugger/debug-interface-access/idiasymbol-get-symtag.md)|`DWORD`|返回 `SymTagVTableShape` () 的 [SymTagEnum 枚举](../../debugger/debug-interface-access/symtagenum.md) 值之一。|
