...
description: 了解 .NET Framework 中的代码访问安全性约束的影响，这些约束可以限制对 ClickOnce 应用程序的代码的访问。
...
## <a name="code-access-security-policies"></a>代码访问安全性策略
 ...
 作为开发人员，您有责任确保您的应用程序将以适当的权限运行。 如果应用程序在运行时请求区域之外的权限，则可能会出现安全性异常。 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 使你能在目标安全区域中调试应用程序，且有助于开发安全的应用程序。 有关详细信息，请参阅[调试使用 System.Deployment.Application 的 ClickOnce 应用程序](../deployment/debugging-clickonce-applications-that-use-system-deployment-application.md)。
