...
description: 了解如何配置 ClickOnce 应用程序，以便在具有较新文件版本和程序集版本的程序集可用时自动更新。
...
## <a name="create-an-update-consent-dialog-box"></a>创建一个“更新同意”对话框
...
25. 如果最终用户不同意联机更新，则更新应用程序以返回错误。
    ...
    6. 在“启动对象”下拉菜单中，选择“Module1” 。
       ...
       > [!NOTE]
       > 禁用应用程序框架时，将禁用一些功能，例如 Windows XP 视觉对象样式、应用程序事件、初始屏幕、单实例应用程序等。 有关详细信息，请参阅 [Application Page, Project Designer (Visual Basic)](../ide/reference/application-page-project-designer-visual-basic.md)（应用程序页、项目设计器 (Visual Basic)。
...
## <a name="set-the-update-consent-application-as-a-prerequisite"></a>将更新同意应用程序设置为必备组件
 在 Visual Studio 中，你可以将更新同意应用程序设置为必备组件。

#### <a name="to-set-the-update-consent-application-as-a-prerequisite"></a>将更新同意应用程序设置为必备组件
...
#### <a name="to-create-and-test-the-setup-program-by-not-clicking-i-agree"></a>在不单击“我同意”的情况下创建和测试安装程序
...
#### <a name="to-create-and-test-the-setup-program-by-clicking-i-agree"></a>在单击“我同意”的情况下创建和测试安装程序
