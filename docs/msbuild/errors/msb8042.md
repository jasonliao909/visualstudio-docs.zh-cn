---
title: MSBuild 错误 MSB8042
description: 如果已请求使用 ATL 或 MFC Spectre 缓解库，但尚未安装，则会出现 MSBuild 错误 MSB8042。
ms.date: 05/27/2021
...
ms.locfileid: "131126878"
---
# <a name="msbuild-error-msb8042"></a>MSBuild 错误 MSB8042
