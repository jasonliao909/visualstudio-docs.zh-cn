...
description: 描述 MSBuild ClangCompile 任务的目的和参数，该任务会包装 C++ 编译器工具 (clang.exe)。
...
|**MSCompatibility**|可选的 bool  参数。<br/><br/>启用 Microsoft C++ 完全兼容性。|
...
|**详细**|可选的 bool  参数。<br/><br/>显示要运行的命令，并使用详细输出。|
