...
ms.workload:
- multiple
ms.openlocfilehash: ab3f292251aa9d368cbbd06393bff5e391eb6e09
ms.sourcegitcommit: edf8137cd90c67b6078a02c93094f7e1c3bf8930
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/08/2022
ms.locfileid: "139549918"
---
...
| `MSBuildWarningsAsErrors` | 已知 | 要视为错误的警告代码的列表。 | `MSB1234;MSB5678`|
| `MSBuildWarningsNotAsErrors` | 已知 | 即使将开关设置为将所有其他警告提升为错误，也 `-warnAsError` 不应升级到错误的警告代码的列表。 请注意，如果不是 true，则它不起作用。 | `MSB1234;MSB5678`|
| `MSBuildWarningsAsMessages` | 已知 | 要视为消息的警告代码的列表。 | `MSB1234;MSB5678`|
