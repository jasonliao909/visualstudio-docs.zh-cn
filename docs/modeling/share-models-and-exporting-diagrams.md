---
title: 共享模型和导出关系图
description: 了解如何使用 Visual Studio 创建和编辑模型、依赖项关系图和定向关系图。
...
## <a name="working-on-a-model-as-a-team"></a>作为团队处理模型
 ...
 不同的用户可以同时对一个模型进行处理，但所处理的应该是不同的包。

 有关在中型或大型项目中组织模型的建议，请参阅[安排你的建模解决方案](../modeling/structure-your-modeling-solution.md)。
...
## <a name="reading-and-reviewing-models"></a>读取和查看模型
 ...
 依赖项关系图仅可在创建它的模型内打开。 若要提供对关系图的访问，你必须提供对所有建模项目文件的访问，或提供其副本。
