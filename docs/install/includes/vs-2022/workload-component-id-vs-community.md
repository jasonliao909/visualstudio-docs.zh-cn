...
ms.topic: include
ms.openlocfilehash: baa66a5df2e1267fe867396c47a8fa82584168f2
ms.sourcegitcommit: edf8137cd90c67b6078a02c93094f7e1c3bf8930
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/08/2022
ms.locfileid: "139551803"
---
## <a name="visual-studio-core-editor-included-with-visual-studio-community-2022"></a>Visual Studio 2022 (中Visual Studio Community核心编辑器) 
...
Microsoft.VisualStudio.Component.AspNet | .NET Framework项目和项模板 | 17.1.32112.364 | 可选
Microsoft.VisualStudio.Component.AspNet45 | 高级 ASP.NET 功能 | 17.1.32112.364 | 可选
...
Microsoft.VisualStudio.ComponentGroup.WindowsAppSDK.Cs | Windows App SDK C# 模板 | 17.1.32112.364 | 可选
...
**描述：** 创建和调试在 Linux 环境或嵌入式设备上运行的应用程序。
...
Microsoft.VisualStudio.Component.Embedded | 嵌入式和 IoT 工具 | 17.1.32112.364 | 建议
Microsoft.VisualStudio.Component.IntelliCode | IntelliCode | 17.1.32112.364 | 建议
Microsoft.VisualStudio.ComponentGroup.WebToolsExtensions | ASP.NET 和 Web 开发 | 17.1.32112.364 | 建议
Component.MDD.Linux.GCC.arm | 旧版嵌入式和 IoT 工具 | 17.1.32112.364 | 可选
...
VisualStudio。 | .NET Framework 项目和项模板 | 17.1.32112.364 | 可选
Microsoft.VisualStudio.Component.AspNet45 | 高级 ASP.NET 功能 | 17.1.32112.364 | 可选
