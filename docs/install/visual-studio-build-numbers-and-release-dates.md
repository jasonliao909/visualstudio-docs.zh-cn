...
ms.openlocfilehash: fcf3b43b8add138af7cbaab6a4a62b27559a892f
ms.sourcegitcommit: 72f8ce4992cc62c4833e6dcb0f79febb328c44be
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/14/2021
ms.locfileid: "130011167"
---
# <a name="visual-studio-build-numbers-and-release-dates"></a>Visual Studio 内部版本号和发布日期

::: moniker range="vs-2022"

## <a name="visual-studio-2022-rc"></a>Visual Studio 2022 RC

下表列出了 Visual Studio 2022 RC 的最新生成号和发布日期。

| **Version**| **频道** | **发布日期** | **内部版本** |
| ---------------------- | ----------- | ---------------- | ----------------- |
| 17.0.0 | 预览版 5/候选发布 (RC) | 2021年10 月 12 日 | 17.0.31808.319 |
