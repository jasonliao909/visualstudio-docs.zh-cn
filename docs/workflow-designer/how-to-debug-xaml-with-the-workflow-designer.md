...
description: 了解如何以 XAML 的形式定义工作流，以及如何使用工作流设计器调试 XAML。
...
2. 对要调试的一个或多个活动设置断点，如[如何：在工作流中设置断点](../workflow-designer/how-to-set-breakpoints-in-workflows.md)中所述。
...
5. 当代码执行到你设置的其中一个断点处时，与该断点关联的 XAML 元素将突出显示。 若要移到下一个断点，请使用 F10 或 F11 键。
