...
ms.locfileid: "99961295"
---
# <a name="flowchart-activity-designer"></a>流程图活动设计器

<xref:System.Activities.Statements.Flowchart> 活动用于创建定义和管理复杂流控制的工作流。 <xref:System.Activities.Statements.Flowchart>可以使用代码或工作流设计器来编写。 本主题介绍工作流设计器体验。 使用工作流设计器工作流活动设计器，开发人员可通过自然方式创作工作流。
