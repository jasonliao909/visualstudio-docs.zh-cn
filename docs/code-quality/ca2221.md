...
description: 公共类型实现的终结器未指定家族（受保护的）访问。
ms.date: 10/16/2019
ms.topic: reference
f1_keywords:
- CA2221
...
若要解决此规则的冲突，请将终结器更改为可以进行系列访问。

## <a name="when-to-suppress-warnings"></a>何时禁止显示警告
不禁止显示此规则发出的警告。

## <a name="example"></a>示例
在任何高级 .NET 语言中都不能违反此规则；如果你正在编写 Microsoft 中间语言，则可能违反此规则。
