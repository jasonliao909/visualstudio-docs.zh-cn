...
description: 未标记为 System.runtime.compilerservices 的程序集中的成员或被标记为以 runtimecompatibility (WrapNonExceptionThrows = false) 包含处理 system.exception 的 catch 块，并且不包含立即遵循的常规 catch 块。
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- CA2102
