...
ms.workload:
- multiple
ms.openlocfilehash: 06b5f1c9f3bf2a896b9dd16db29e309bc6676e73be8a1232690bbe45f20a37bb
ms.sourcegitcommit: c72b2f603e1eb3a4157f00926df2e263831ea472
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/12/2021
ms.locfileid: "121456084"
---
...
## <a name="example"></a>示例
下面的示例演示了与规则冲突的类型。 kernel32.dll 中不存在名为的函数 `DoSomethingUnmanaged` 。
