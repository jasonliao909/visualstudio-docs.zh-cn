...
### <a name="sign-your-assembly-with-a-strong-name-in-visual-studio"></a>使用强名称为程序集签名 Visual Studio

1. 在 Visual Studio 中，打开解决方案。
...
### <a name="sign-your-assembly-with-a-strong-name-outside-visual-studio"></a>在 Visual Studio 之外使用强名称为程序集签名
