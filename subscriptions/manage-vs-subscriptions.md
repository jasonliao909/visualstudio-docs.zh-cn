...
ms.openlocfilehash: 270eaf1868fe06f01284ea7fd923f7244260f32a
ms.sourcegitcommit: 3034382894e610b55f3ad07e737fa59b91680869
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/03/2022
ms.locfileid: "144547794"
---
...
Visual Studio 订阅门户将所有 Visual Studio 订阅和程序汇集到一个改进的门户体验中。 例如，你可能有一个订阅通过工作，另一个订阅或Visual Studio Dev Essentials在家使用的成员身份。
...
+ 它可能与其他电子邮件地址相关联。 如果有多个订阅，并且它们被分配到不同的电子邮件地址，则一次只能看到一个订阅。  若要切换到其他订阅，请注销门户，并使用与所需订阅关联的电子邮件登录。  
...
**通过计划获得的订阅：** 如果通过计划获得订阅，则该订阅与你在计划中的参与状况关联。 联系计划联系人以获取其他信息。
...
如果你的订阅是通过 Microsoft 批量许可购买的，并且你需要将其重新分配给组织中的其他人，你的管理员可以为你执行此操作。
...
若要接收有关订阅和权益的定期更新和新闻稿，[请更新首选项](https://app.vsaex.visualstudio.com/me?workflowID=devprogram&tab=edit)，并选中Visual Studio配置文件中Visual Studio 订阅框。 可以随时更改这些首选项，或取消订阅。 
