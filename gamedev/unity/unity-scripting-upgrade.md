...
description: 了解如何在 Unity 中使用 .NET 4.x。 启用 .NET 4.x 脚本运行时。 利用 .NET 兼容性。 查看新的语法和语言功能。
author: therealjohn
ms.author: johmil
ms.date: 08/29/2018
ms.topic: how-to
...
![选择 .NET 4.x 等效项](media/vs/vstu-scripting-runtime-version.png)
...
![MonoBleedingEdge 目录](media/vs/vstu-monobleedingedge.png)
...
1. 单击“Download”按钮：
    ...
    ![“下载”按钮](media/vs/vstu-nuget-download.png)
